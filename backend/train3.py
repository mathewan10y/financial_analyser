...
# 2. Load Stage 1 model directly from Hugging Face
model_path = "mathewan10y/synapse-financial-sentiment" 
...
training_args = TrainingArguments(
    output_dir="./synapse_regression_model", # Saves intermediate checkpoints here
...
# 8. Explicitly Save the Final Regression Model and Tokenizer
print("\nStep 8: Saving Final Stage 2 Regression Model...")
trainer.save_model("./synapse_regression_model")
tokenizer.save_pretrained("./synapse_regression_model")
print("Stage 2 Model successfully saved to './synapse_regression_model'")